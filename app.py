# Kevin Alejandro Abadia    -  2025825-3743
# Daniel Jose Cubides       -  2028844-3743
# Cristian Camilo Torijano  -  2025808-3743
...
#
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:admin@localhost:5432/postgresdb'
db = SQLAlchemy(app)
